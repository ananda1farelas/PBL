...
INSERT INTO permissions (name, description) VALUES
    ...
    ('user:read:any', 'meilhat data user mana  pun'),
    ('user:update:any', 'mengubah data user mana pun'),
    ('user:delete', 'menghapus user'),
    ('user:assign', 'mengubah role milik user lain')
ON CONFLICT (name) DO NOTHING;
...
ALTER TABLE users ADD CONSTRAINT users_role_fkey FOREIGN KEY (role) REFERENCES roles(name) ON DELETE SET NULL;
